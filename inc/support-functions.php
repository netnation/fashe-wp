	...
	<?php endif; ?>
		<div class="comment--meta-info">
			...
			<div class="comment__info">
				<cite><?php printf( esc_html__( '<span class="comment-author-name">%s</span> ', 'fashe' ), get_comment_author_link() ); ?></cite>
				<div class="comment__meta">
					<time class="comment__time"> <?php printf( esc_html__( '%1$s at %2$s', 'fashe' ), get_comment_date(), get_comment_time() ); ?><?php edit_comment_link( esc_html__( '(Edit)', 'fashe' ), '  ', '' ); ?></time>
